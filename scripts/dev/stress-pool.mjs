...
//
// Usage:
//   node scripts/dev/stress-pool.mjs
//   SERVER_URL=http://localhost:3000 CONCURRENCY=50 DURATION_S=60 node scripts/dev/stress-pool.mjs
//
// Before running:
...
//   3. node scripts/dev/stress-pool.mjs
