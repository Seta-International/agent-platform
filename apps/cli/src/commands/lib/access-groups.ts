...
export const PERSONA_GROUPS: PersonaGroupDef[] = [
  {
    ...
    name: 'Member',
    is_base: true,
    roles: ['planner.contributor', 'knowledge.member', 'agent.contributor'],
  },
  { slug: 'hr', name: 'HR', roles: ['people.strategic', 'hiring.strategic', 'hiring.recruiter'] },
  { slug: 'pmo', name: 'PMO', roles: ['pm.pmo'] },
  { slug: 'am', name: 'AM', roles: ['pm.strategic'] },
  { slug: 'bod', name: 'BoD', roles: ['pm.bod', 'people.viewer', 'hiring.viewer'] },
  {
    slug: 'team-lead-pm',
    name: 'Team Lead/PM',
    roles: ['pm.strategic', 'planner.contributor', 'people.viewer', 'hiring.recruiter'],
  },
