...
import type { RejectApplicationInput } from '../../contracts.ts';
import { HIRING_APPLICATION_REJECTED, HIRING_APPLICATION_STAGE_CHANGED } from '../../events.ts';
import { hiringDb } from '../db/client.ts';
import { application, rejectionReason } from '../db/schema.ts';
