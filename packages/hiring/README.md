...
> TODO: one-paragraph description of the hiring module — what domain it owns and what surface it exposes.

## Public surface

- `@seta/hiring` — application services (Node)
- `@seta/hiring/events` — event type constants + zod payload schemas
- `@seta/hiring/rbac` — permission constants
- `@seta/hiring/contracts` — browser-safe DTOs + zod schemas
- `@seta/hiring/register` — `ContributionRegistry` hook (Node)
