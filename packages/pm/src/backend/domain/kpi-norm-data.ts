...
export const KPI_NORM_METRICS: readonly KpiNormMetricSeed[] = [
  ...
  },
  {
    ...
    red_band: gt(3),
    insight:
      'Long-lived defects = growing backlog, blocked tests. Simplified: use the Sev1 threshold (stricter than Sev2) as a single value.',
    is_live_capable: false,
    sort_order: 7,
  },
  {
  ...
  // C — Cost & Capacity — EXTENDED
  {
    ...
    insight:
      'Drift = lower productivity or wrong rate-card. Enter the baseline as the denominator to compare against (instead of storing a multi-period trend).',
    is_live_capable: false,
    sort_order: 18,
  },
  {
  ...
  // D — Delivery — EXTENDED
  {
    ...
    red_band: lt(0.033),
    insight:
      'DORA #1 — Elite = on-demand. Approx: ≥1/day = Green, weekly–monthly = Yellow, <monthly = Red.',
    is_live_capable: false,
    sort_order: 29,
  },
  {
