 ...
 * Generated: 2026-07-13T05:22:20.103Z
 */

/**
 * seta theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { setaTheme } from './seta';
 *   import './seta.css';
 */
export const setaTheme = {
  name: 'seta',
  __built: true,
  tokens: {
    ...
    "--font-family-heading": "Geist, -apple-system, system-ui, sans-serif",
    "--font-family-code": "\"Geist Mono\", ui-monospace, SF Mono, Menlo, monospace",
    ...
    "--color-background-surface": "light-dark(#FDFBFF, #1C1A24)",
    "--color-background-body": "light-dark(#F2EFFC, #120F1A)",
    "--color-background-card": "light-dark(#FDFBFF, #1C1A24)",
    "--color-background-popover": "light-dark(#FDFBFF, #312F39)",
    "--color-background-muted": "light-dark(#1C1A240D, #1C1A2480)",
    "--color-accent": "light-dark(#0047FF, #0047FF)",
    "--color-accent-muted": "light-dark(#0045FD33, #CBBEFF40)",
    "--color-neutral": "light-dark(#1C1A241A, #E4E1EE33)",
    "--color-overlay": "light-dark(#1C1A2466, #1C1A2499)",
    "--color-overlay-hover": "light-dark(#1C1A240D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#1C1A241A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#1C1A24, #E4E1EE)",
    "--color-text-secondary": "light-dark(#484554, #ADA9BB)",
    "--color-text-disabled": "light-dark(#928EA0, #605C6C)",
    "--color-text-accent": "light-dark(#0031CE, #CBBEFF)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #001F9D)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#0045FD, #CBBEFF)",
    "--color-icon-primary": "light-dark(#1C1A24, #E4E1EE)",
    "--color-icon-secondary": "light-dark(#484554, #ADA9BB)",
    "--color-icon-disabled": "light-dark(#928EA0, #605C6C)",
    ...
    "--color-border": "light-dark(#1C1A241A, #F2EFFC1A)",
    "--color-border-emphasized": "light-dark(#ADA9BB, #484554)",
    "--color-skeleton": "light-dark(#ADA9BB, #484554)",
    ...
    "--color-background-inverted": "light-dark(#1C1A24, #FDFBFF)",
    "--color-track": "light-dark(#ADA9BB, #484554)",
    "--radius-chat": "28px"
  },
