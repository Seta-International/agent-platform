...
> TODO: one-paragraph description of the people module — what domain it owns and what surface it exposes.

## Public surface

- `@seta/people` — application services (Node)
- `@seta/people/events` — event type constants + zod payload schemas
- `@seta/people/rbac` — permission constants
- `@seta/people/contracts` — browser-safe DTOs + zod schemas
- `@seta/people/register` — `ContributionRegistry` hook (Node)
