...
import { taskDetailQualitySuite } from '../../../src/backend/orchestration/eval-manifest.ts';
...
// with a real model). Mirrors task-query.quality.test.ts.
