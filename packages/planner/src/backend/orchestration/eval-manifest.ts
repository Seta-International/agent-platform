...
export const taskSearchEvalSuite = defineEvalSuite({
  specId: 'planner.query.taskQuery',
  buildSpec: () =>
...
export const queryOrchestratorEvalSuite = defineEvalSuite({
  ...
  buildSpec: () =>
    makeQueryOrchestrator({
      taskQuery: stubSubAgent('planner.query.taskQuery'),
...
export const queryGeneralAnswerQualitySuite = defineEvalSuite({
...
export const plannerEvalManifest: EvalManifest = {
  ...
  suites: [
    ...
    queryGeneralAnswerQualitySuite as EvalSuite,
  ],
};
