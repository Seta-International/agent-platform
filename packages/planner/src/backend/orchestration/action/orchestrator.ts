...
export function instructionsText(): string {
  return [
    ...
    'create tasks, permanently delete anything, or answer general questions. If the user',
    'wants a task gone: when it duplicates another task, offer planner_mergeTasks;',
    'otherwise tell them they can move it to the trash themselves from the task menu.',
    '',
