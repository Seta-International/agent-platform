...
import { PlanBoardShell } from '../../pages/plan-board-shell';
import { serializeFiltersToSearch } from '../../state/url-state';
  ...
  return (
    <>
      <PlanBoardShell
        ...
        onChartPatch={(extra) => navigate({ search: (prev) => ({ ...prev, ...extra }) })}
      />
      {selectedTaskId && (
        <TaskDetailDialog
          planId={planId}
