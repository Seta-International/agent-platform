...
const CANNOT_CONFIGURE_REASON = "You don't have permission to configure mail transport.";

export function MailTransport() {
  const canConfigure = usePermission('integrations.mail.configure');
      ...
      <div className="page-container space-y-4">
        ...
        <Card className="p-5 space-y-5">
          <DisabledActionTooltip
            ...
            reason={CANNOT_CONFIGURE_REASON}
            ...
            <div className="flex items-center justify-end gap-2">
              {enabled && (
                <Button
                  ...
                  disabled={disable.isPending || !canConfigure}
                >
                  Disable
                </Button>
              )}
              <Button
                ...
                disabled={save.isPending || isLoading || !canConfigure}
              >
          ...
          >
            <div className="flex gap-2">
              ...
              <Button
                ...
                disabled={verify.isPending || !verifyEmail || !enabled || !canConfigure}
              >
                Send test
              </Button>
            </div>
