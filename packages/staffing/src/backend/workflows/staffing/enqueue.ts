...
import type { TaskSkillItem } from '../../agent-tools/analyzer/planner.build-task-skill-queue.ts';
import type { UserAvailabilityResult } from '../../agent-tools/avai-checker/build-availability-queue.ts';
import type { RankedCandidate } from '../../agent-tools/skill-matcher/rank-candidates.ts';
import {
